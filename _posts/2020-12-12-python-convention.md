...
public 모듈, 함수, 클래스, 함수에 대해서는 Docstrings을 사용하도록 하자. 무슨 역할을 하는지에 대해 작성하는 것이 좋으며 def문장 바로 아래줄에 작성하자.
...
- single*trailing_underscore* : 파이썬 기본 키워드와 충돌을 피하려고 사용한다.
- **double_leading_underscore : 클래스 속성으로 사용되면 그 이름을 변경한다. (ex. FooBar에 정의된 **boo는 \_FooBar\_\_boo로 바뀝니다.)
- **double_leading_and_trailing_underscore**: magic 객체', 사용불가, 미리 정의되어 있는 이름만 사용 가능하다.
